...
int main(int argc, char *argv[]) {
    ...
    // Registrarse (enviar nickname junto al paquete)
    ...
    size_t nick_len = strlen(nickname) + 1; // +1 para incluir el '\0'
    ...
    memcpy(reg_buf + sizeof(reg_pkt_t), nickname, nick_len); // incluimos el '\0'
